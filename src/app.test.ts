...
const srequest = request.agent(server);
...
describe('App', () => {
  ...
  describe('when GET /not-exists', () => {
    it('should return the 404 page', (done) => {
      srequest.get('/not-exists').expect(404, done);
    });
  });

  describe('when GET /execute', () => {
    it('should return work', (done) => {
      srequest
        .post('/execute')
        .send({
          transaction: {
